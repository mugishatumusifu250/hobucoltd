...
import { consultationsAPI, usersAPI } from '../api';
...
const DashboardManager = () => {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [consultationsRes, usersRes] = await Promise.all([
            ...
            <div className="widget-grid">
              <div className="widget-card">
                ...
                <div className="widget-content">
                  <h3 className="widget-title">Total Users</h3>
              ...
              <div className="widget-card">
                ...
                <div className="widget-content">
                  <h3 className="widget-title">Total Consultations</h3>
